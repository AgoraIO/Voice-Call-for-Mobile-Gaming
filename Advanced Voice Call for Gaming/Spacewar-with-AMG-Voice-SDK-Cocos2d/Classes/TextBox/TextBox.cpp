...
bool TextBox::initWithBackgroundImg(const std::string bg)
{
    ...
    do {
        ...
        txt_ = cocos2d::Label::createWithTTF("Msg Box", "fonts/arial.ttf", 10, cocos2d::Size(getContentSize().width - 40, getContentSize().height - 40));
#else
        txt_ = cocos2d::Label::createWithTTF("Msg Box", "fonts/arial.ttf", 50, cocos2d::Size(getContentSize().width - 40, getContentSize().height - 40));
#endif
